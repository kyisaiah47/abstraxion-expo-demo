...
const SAMPLE_JOBS: Job[] = [
	{
		...
		description:
			"Looking for detail-oriented individuals to help with data entry tasks. Clean and organize customer information databases.",
	...
	},
	{
		...
		description:
			"Review and moderate user-generated content according to community guidelines. Ensure platform safety and quality.",
	...
	},
	{
		...
		description:
			"Verify and categorize images for machine learning training datasets. Help improve AI accuracy.",
	...
	},
	{
		...
		description:
			"Collect and validate survey responses. Ensure data quality and completeness for market research.",
...
export default function SophisticatedMarketplace() {
	...
	const filteredJobs = jobs.filter((job) => {
		...
		if (activeFilter === "high-pay")
			return matchesSearch && job.salary.min >= 20;
	...
	const renderJobCard = ({
		...
		>
			...
			<View style={styles.jobFooter}>
				...
				>
					<Text
						style={[styles.jobTypeText, { color: getJobTypeColor(job.type) }]}
					>
						{job.type.replace("-", " ")}
					</Text>
				</View>
