...
export default function ProofIDScreen() {
  ...
  const { logout } = require('@burnt-labs/abstraxion-react-native').useAbstraxionAccount();
    ...
    <View style={styles.statsCard}>
      <View style={styles.statsHeader}>
        <View style={styles.statsHeaderContent}>
          <Ionicons name="shield-checkmark" size={20} color={DesignSystem.colors.primary[700]} />
      ...
      <View style={styles.statsGrid}>
        ...
        <View style={styles.statItem}>
          <Text style={styles.statValue}>${userStats.verifiedBalance.toFixed(0)}</Text>
        ...
        <View style={styles.statItem}>
          <Text style={styles.statValue}>
            {Math.floor((Date.now() - userStats.activeSince.getTime()) / (1000 * 60 * 60 * 24))}d
          </Text>
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <SophisticatedHeader
        title="Proof ID"
        subtitle="Your verified digital identity"
      />
