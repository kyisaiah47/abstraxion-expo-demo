...
export default function SophisticatedDashboard() {
  const earningsData: EarningsData[] = [
    { period: 'Today', amount: 245.80, change: 12.5 },
    { period: 'This Week', amount: 1847.20, change: 8.2 },
      ...
      >
                ...
                <View style={styles.earningsCardContent}>
                  ...
                  <View style={styles.changeContainer}>
                    ...
                    <Text style={[
                      styles.changeText,
                      index === 0 && styles.primaryText,
                      !index && item.change < 0 && { color: DesignSystem.colors.text.inverse },
                      index > 0 && {
                        color: item.change >= 0
                          ? DesignSystem.colors.status.success
                          : DesignSystem.colors.status.error
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              <View style={[styles.quickActionIcon, { backgroundColor: DesignSystem.colors.status.info + '20' }]}>
                <Ionicons
                  name="search"
                  size={24}
              ...
              <Text style={styles.quickActionSubtitle}>Browse available tasks</Text>
            </Pressable>
            ...
            >
              <View style={[styles.quickActionIcon, { backgroundColor: DesignSystem.colors.status.success + '20' }]}>
                <Ionicons
                  name="add"
                  size={24}
